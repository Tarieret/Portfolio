...
This project explores how Retrieval-Augmented Generation can make domain-specific medical research easier to work with. It ingests peer-reviewed papers on brain tumor detection, indexes them using semantic embeddings, and returns citation-backed answers through a FastAPI backend and a Streamlit interface. The original MRI classification project can also be found in my archived projects [here](https://github.com/Tarieret/Archived_Projects/tree/main/Brain_Tumor_Classification).
...
- **Repo:** [*In Progress*](https://github.com/Tarieret/StyleSignal-Customer-Sentiment-Retention-Analytics-)
